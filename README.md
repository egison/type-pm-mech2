...
2. `TotalCoreTyping.commonFuelSafety`を壊して前提を一つだけ交換するのではなく，環境・成功値・探索回答の
   ...
   workと一段のevaluator／dispatcher保存を構成し，この探索定理を式評価全体へ接続する．P1-L01で既に証明した
   三種類のatom関係は，fixture固有の局所証明ではなくM4 clause導出から生成する経路へ置き換える．
